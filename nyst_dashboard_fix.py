...
df_date = pd.read_csv('NYCitiBike_trip_season.csv', index_col = 0)
...
if page == "Intro page":
    ...
    myImage = Image.open("citibike_img.jpg")  # source: https://unsplash.com/photos/bicycles-parked-on-the-side-of-a-street-KcOoW1Tv06Q
    st.image(myImage)
...
### Most popular stations bar chart page ###
    ...
    with st.sidebar:
        season_filter = st.multiselect(label='Select the season', options=df_date['season'].unique(),
                                       default=df_date['season'].unique())

    df1 = df_date.query('season == @season_filter')
...
### Conclusion page ###
    ...
    myImage = Image.open("citibike_img2.jpg")  # source: https://unsplash.com/photos/blue-citi-bike-bicycles-parked-on-sidewalk-8ol9rD0BHAU
    st.image(myImage)
